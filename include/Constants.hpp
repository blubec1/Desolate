...
const float WANDERER_AGGRO_RANGE = 125.f;
const float WANDERER_DE_AGGRO_RANGE = 125.f;
const float WANDERER_DE_AGGRO_COOLDOWN = 3.f;
const float WANDERER_TIME_TO_APPEAR = 0.5f;

const float TERRITORIAL_RADIUS = 10.f;
...
const float OUTPOST_RADIUS = 10.f;
const float OUTPOST_HEAL_RANGE = 100.f;
const float OUTPOST_HEAL_PERCENTAGE = 20.f;
const float OUTPOST_TRIGGER_RADIUS = 100.f;
...
const float SQUAD_DAMAGE = 5.f;
const float SQUAD_SHOOT_RANGE = 75.f;
...
const float LURKER_AGGRO_RANGE = 100.f;
const float LURKER_DE_AGGRO_RANGE = 150.f;
const float LURKER_DE_AGGRO_COOLDOWN = 3.f;
const float LURKER_ARRIVAL_DISTANCE = 40.f;
const float LURKER_VISIBILITY_RANGE = 100.f;
const float LURKER_TIME_TO_APPEAR = 0.5f;

const sf::Color HUNTER_COLOUR = sf::Color(30, 30, 30);
const float HUNTER_RADIUS = 10.f;
const float HUNTER_BASE_SPEED = 7.5f;
const float HUNTER_MAX_SPEED = 50.f;
const float HUNTER_RAMP_UP_TIME = 5.f;
const float HUNTER_KILL_RANGE = 6.f;
const float HUNTER_MAX_HEALTH = 500.f;
const float HUNTER_VIEW_RANGE = 40.f;
...
const float STANDARD_AUDIO_COMBAT_WINDOW = 2.f;
