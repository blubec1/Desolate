...
const float WANDERER_RADIUS = 25.f;
...
const float TERRITORIAL_RADIUS = 25.f;
...
const float OUTPOST_PROTECT_RANGE = 500.f;
...
const float RESOURCE_RADIUS = 15.f;
...
const float LURKER_RADIUS = 20.f;
...
const float HUNTER_LAIR_RADIUS = 20.f;
